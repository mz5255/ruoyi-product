  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="光照" prop="illumination">
        <el-input
          v-model="queryParams.illumination"
          placeholder="请输入光照"
          clearable
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="农作物信息ID" align="center" prop="cropInfoId"  v-if="columns[2].visible" />
      <el-table-column label="记录时间" align="center" prop="recordTime" width="180"  v-if="columns[3].visible">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.recordTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="温度" align="center" prop="temperature"   v-if="columns[4].visible"/>
      <el-table-column label="生长状况" align="center" prop="arowths"  v-if="columns[5].visible"/>
      <el-table-column label="湿度" align="center" prop="humidness"  v-if="columns[6].visible" />
      <el-table-column label="光照" align="center" prop="illumination"  v-if="columns[7].visible" />
      <el-table-column label="农作物图片" align="center" prop="pic"  v-if="columns[8].visible" >
        <template v-slot="scope">
          <el-image :src = scope.row.pic></el-image>
        </template>
      </el-table-column>
      <el-table-column label="备注信息" align="center" prop="remark"  v-if="columns[9].visible" />
      <el-table-column label="操作人" align="center" prop="operator"  v-if="columns[10].visible" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="农作物信息ID" prop="cropInfoId">
              <el-input v-model="form.cropInfoId" placeholder="请输入农作物信息ID" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
import {listInfo, getInfo, delInfo, addInfo, updateInfo, getListUser, downExcel} from "@/api/system/planinfo";
